...
class CovidModel:
	...
	def __repr__(self):
		return f"State Name = {self.state_name}, Confirmed = {self.confirmed}, Active = {self.active}, Recovered = {self.recovered}, Deceased = {self.deceased}, Tested = {self.tested}, Vaccine Dosses Administered = {self.vaccine_doses}."
